  ...
  css: {
    ...
    loaderOptions: {
      less: {
        ...
        modifyVars: {
          "@toast-max-width": "100%",
          "@toast-default-width": "80%",
          "@toast-font-size": "14px",
          "@tab-font-size": "18px",
          "@tab-text-color": "#939598",
          "@tab-active-text-color": "#3290A0",
          "@tabs-nav-background-color": "#E8EFF2",
          "@tabs-bottom-bar-width": "50%",
          "@tabs-bottom-bar-height": "2px",
          "@tabs-bottom-bar-color": "#3290A0",
          "@tabs-default-color": "#BCBEC0"
        }
      }
    },
